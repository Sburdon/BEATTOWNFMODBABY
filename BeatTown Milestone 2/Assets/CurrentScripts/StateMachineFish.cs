...
[CreateAssetMenu(fileName = "FishAnimationSet", menuName = "Animation/FishAnimationSet", order = 1)]
public class FishAnimationSet : ScriptableObject
{
...
public class StateMachineFish : MonoBehaviour
{
